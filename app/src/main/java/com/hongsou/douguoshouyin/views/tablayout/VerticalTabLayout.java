package com.hongsou.douguoshouyin.views.tablayout;
...
/**
 * Created by Insist_L on 2018/4/11.
 * TODO:   垂直TabLayout
 */
...
public class VerticalTabLayout extends ScrollView implements View.OnClickListener {
    ...
    public void setTabBadge(int tabPosition, int badgeNum) {
       new QBadgeView(mContext).bindTarget(getTabAt(tabPosition)).setBadgeNumber(badgeNum);
    }
    ...
    private class TabView extends FrameLayout {
        ...
        public TabView(Context context, Tab tab) {
            ...
            mTabItem.setGravity(Gravity.CENTER);
            setPaddings();
            setDrawable();
